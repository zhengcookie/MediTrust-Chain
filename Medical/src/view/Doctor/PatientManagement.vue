...
const handleSearch = async () => {
    const response = await axios.get('/api/patient/getPatientInfo', {
        params: {
...
const savePatient = async () => {
    try {
        await axios.post('/api/doctor/updatePatient', patientForm)
...
const getPatientsInfoByDoctor = async () => {
    ...
    const response = await axios.get('/api/doctor/getPatientsInfoByDoctor', {
        params: {
